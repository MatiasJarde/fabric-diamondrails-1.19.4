...
public class ModItems {
    ...
    public static void addItemsToItemGroup() {
        ...
        //addToItemGroup(ModItemGroup.DIAMOND_RAILS, CITRINE);
        //addToItemGroup(ModItemGroup.DIAMOND_RAILS, RAW_CITRINE);
    }
    ...
    public static void registerModItems() {
        DiamondRails.LOGGER.debug("Registering mod items for " + DiamondRails.MOD_ID);
